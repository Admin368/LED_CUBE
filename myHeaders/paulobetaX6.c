...
void xuplevels(uchar xup);       //[paulobetaX6.h]
void xdownlevels(char xdwn);     //[paulobetaX6.h]
//FUNCTION_CLAIM>>END
...
void xseconds(uchar mm){
    uchar mmm;
    xsecondsstatus=1; //started counting
	for (mmm=0;mmm<mm+1;mmm++)
	{
			xdelayms();
	}
    xsecondsstatus=0;//done counting
}
void xdelayms(){
    uchar ii,jj,kk;
	_nop_();
...
void xuplevels(char xup){
    if (xup == 0){P1 = 0xff;} //xuplevel_0
    if (xup == 1){P1 = 0x7f;} //xuplevel_1
    if (xup == 2){P1 = 0x3f;} //xuplevel_2
    if (xup == 3){P1 = 0x1f;} //xuplevel_3
    if (xup == 4){P1 = 0x0f;} //xuplevel_4
    if (xup == 5){P1 = 0x07;} //xuplevel_5
    if (xup == 6){P1 = 0x03;} //xuplevel_6
    if (xup == 7){P1 = 0x01;} //xuplevel_7
    if (xup == 8){P1 = 0x00;} //uplevel_8 
}

void xdownlevels(char xdwn){
    if (xdwn == 0){P1 = 0xff;} //xdwnlevel_0
    if (xdwn == 1){P1 = 0xfe;} //xdwnlevel_1
    if (xdwn == 2){P1 = 0xfc;} //xdwnlevel_2
    if (xdwn == 3){P1 = 0xf8;} //xdwnlevel_3
    if (xdwn == 4){P1 = 0xf0;} //xdwnlevel_4
    if (xdwn == 5){P1 = 0xe0;} //xdwnlevel_5
    if (xdwn == 6){P1 = 0xc0;} //xdwnlevel_6
    if (xdwn == 7){P1 = 0x80;} //xdwnlevel_7
    if (xdwn == 8){P1 = 0x00;} //xdmnlevel_8 
}
//inlevels
0000 0000 0x [0]
1000 0001 0x [1]
...
1111 1111 0x [4]
void auto_xinlevels(){}
void xinlevels(uchar xinl){
    if (xinl == 0){P1 = 0xff;} //xinlevel_0
    if (xinl == 1){P1 = 0xfe;} //xinlevel_1
    if (xinl == 2){P1 = 0xfc;} //xinlevel_2
    if (xinl == 3){P1 = 0xf8;} //xinlevel_3
	if (xinl == 3){P1 = 0xf8;} //xinlevel_4
}
}
//FUNCTIONS_MAIN>>END
